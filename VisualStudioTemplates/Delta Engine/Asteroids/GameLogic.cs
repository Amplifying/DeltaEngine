...
namespace $safeprojectname$
{
	public class GameLogic : Entity2D
	{
		public GameLogic() : base(Rectangle.Zero)
		{
			...
			Player.ProjectileFired += projectile => 
			{
				ExistantProjectiles.Add(projectile);
			};
		...
		internal class GameLogicsHandler : UpdateBehavior
		{
			...
			private static bool ObjectsInHitRadius(Entity2D entityAlpha, Entity2D entitytBeta, float 
				radius)
			{
