...
namespace $safeprojectname$
{
	internal class InteractionLogics : Entity
	{
		public void FireShotByPlayer(Point startPosition)
		{
			...
			bulletTrail.Start<Transition>().Add(new Transition.Duration(0.2f)).Add(new 
				Transition.ColorRange(Color.Orange, Color.TransparentBlack));
		}
		...
		public void FireShotByEnemy(Point startPosition)
		{
			...
			bulletTrail.Start<Transition>().Add(new Transition.Duration(0.2f)).Add(new 
				Transition.ColorRange(Color.Red, Color.TransparentBlack));
		}
	}
}