	...
	public class AndroidDriverDownloader
	{
		...
		private void DownloadAndroidDriverForWindows8()
		{
			...
			if (!Directory.Exists(expectedDirectory))
				TryDownloadAndroidDriverForWindows8();
		}

		private void TryDownloadAndroidDriverForWindows8()
		{
			try
			{
				DownloadSupportFile("Windows8.zip");
			}
			catch (Exception ex)
			{
		...
		private void TryDownloadAndroidDriverForWindowsLegacy()
		{
			try
			{
				DownloadSupportFile("WindowsLegacy.zip");
			}
			catch (Exception ex)
			{
